...
class MWACLUtils {
  ...
  public:
    ...
    template <typename T>
    static void allocateAndFillTensor(arm_compute::Tensor&, T*, bool& isPadded);
 ...
 */
template <typename T>
void MWACLUtils::allocateAndFillTensor(arm_compute::Tensor& armTensor, T* buffer, bool& isPadded) {
